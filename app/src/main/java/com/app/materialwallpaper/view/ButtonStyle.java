...
public class ButtonStyle extends androidx.appcompat.widget.AppCompatButton {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            int color = getResources().getColor(R.color.color_light_primary);
            ...
            currCorner = typedArray.getDimension(R.styleable.ButtonStyle_corner, getResources().getDimension(R.dimen.default_btn_corner_radius));
